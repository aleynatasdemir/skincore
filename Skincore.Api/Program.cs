...
using (var scope = app.Services.CreateScope())
{
    ...
    var adminExists = mongoDbService.UsersCollection
        .Find(u => u.Email == "admin@skincore.com")
        .FirstOrDefault();
    ...
    if (adminExists == null)
    {
        ...
        mongoDbService.UsersCollection.InsertOne(adminUser);
        Console.WriteLine("\n==================================");
        Console.WriteLine(" ADMIN HESABI OLUŞTURULDU");
