...
enum L10nKey {
    ...
    var tr: String {
        ...
        case .paywallFeature3Title: return "Cilt Uyumluluk Analizi"
        case .paywallFeature3Subtitle: return "Ürünlerin cildinize uygun olup olmadığını analiz et"
        ...
        case .paywallLegal: return "Abonelik seçilen süre sonunda otomatik yenilenir. iTunes hesabından istediğin zaman iptal edebilirsin."
    ...
    var en: String {
        ...
        case .skinCompatButtonLocked: return "Is It Right for My Skin?"
        ...
        case .paywallFeature3Title: return "Skin Compatibility Analysis"
        case .paywallFeature3Subtitle: return "Analyze whether products are right for your skin type"
        ...
        case .paywallLegal: return "Subscription renews automatically at the end of each period. Cancel anytime via your iTunes account."
