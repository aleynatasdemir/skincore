...
INPUT_FILE = f"{BASE_PATH}/loreal_ewg_products.json"
OUTPUT_FILE = f"{BASE_PATH}/embedded_loreal_ewg_products.json"

SKIPPED_FILE = f"{BASE_PATH}/skipped_loreal_ewg_products.json"
FAILED_FILE = f"{BASE_PATH}/api_failed_loreal_ewg_products.json"
