...
# Configuration
JSON_FILE = '/Users/aleyna/Desktop/embedding/loreal_products.json'
EMBEDDING_DIR = '/Users/aleyna/Desktop/embedding/loreal_local_img'
MAX_WORKERS = 10
TIMEOUT = 15
MAX_RETRIES = 3
...
def main():
    ...
    for item in data:
        ...
        # Sadece İLK fotoğrafı al (daha önce görülmediyse)
        ...
        ext = get_ext(url)
        dest = os.path.join(EMBEDDING_DIR, f"{barcode}{ext}")
        tasks.append((barcode, url, dest))
